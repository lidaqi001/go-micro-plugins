...
// 标识这是一个延时队列(订阅)
type isDelayQueueKey struct{}
// IsDelayQueue is flag for a delay queue.

func IsDelayQueue() broker.SubscribeOption {
	return setSubscribeOption(isDelayQueueKey{}, true)
}
